...
- add --force flag ([8033582](https://github.com/henriquehbr/versionem/commit/8033582))
...
- get locale time instead iso time on releases ([ade0331](https://github.com/henriquehbr/versionem/commit/ade0331))
